...
class CalibrationThresholdRepositoryTest {
	...
	void updateCalibrationThresholdsUpdatesAllCalibrationThresholdRowsInTransaction() throws Exception {
		...
		repository.updateCalibrationThresholds(4, "namrc", new BigDecimal("90000000"), new BigDecimal("4500000"),
				new BigDecimal("4.5"), new BigDecimal("4.25"), 3);
		...
		assertEquals(List.of("ONE_TIME_MIN_TOTAL_AMOUNT", "CUMULATIVE_MIN_TOTAL_AMOUNT", "QUANTITY_TOLERANCE_PERCENT",
				"TOTAL_AMOUNT_TOLERANCE_PERCENT"), thresholdNameCaptor.getAllValues());
		assertEquals(List.of(new BigDecimal("90000000"), new BigDecimal("4500000"), new BigDecimal("4.5"),
				new BigDecimal("4.25")), thresholdValueCaptor.getAllValues());
	...
	void updateCalibrationThresholdsRejectsNonCalibrationRegionAppIdPair() throws Exception {
		...
		IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
				() -> repository.updateCalibrationThresholds(3, "APACC", BigDecimal.ONE, BigDecimal.ONE, BigDecimal.ONE,
						BigDecimal.ONE, 4));
