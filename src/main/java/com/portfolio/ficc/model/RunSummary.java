...
public record RunSummary(int appId, int modelId, String modelCode, String region, LocalDate businessDate,
		int tradesProcessed, int alertsGenerated, int alertsDispatched, int duplicateAlerts) {
