...
public record Alert(String alertId, String alertType, String matchType, Trade tradeA, Trade tradeB,
		List<Trade> relatedTrades, BigDecimal totalBuyQuantity, BigDecimal totalSellQuantity, BigDecimal totalBuyAmount,
		BigDecimal totalSellAmount, BigDecimal thresholdAmount, List<String> reasons, Instant createdAt) {
