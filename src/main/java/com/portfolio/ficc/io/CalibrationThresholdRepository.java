...
public class CalibrationThresholdRepository {
    ...
    private static final Map<String, Integer> CALIBRATION_APP_IDS = Map.of(
            "NAMRC", 4,
            "EMEAC", 5,
            "APACC", 6
    );
    ...
    public void updateCalibrationThresholds(
        ...
        try (Connection connection = getConnection()) {
            ...
            try {
                ...
                updateThreshold(connection, appId, normalizedRegion, ONE_TIME_MIN_TOTAL_AMOUNT, oneTimeMinTotalAmount, 0);
                updateThreshold(connection, appId, normalizedRegion, CUMULATIVE_MIN_TOTAL_AMOUNT, cumulativeMinTotalAmount, cumulativeLookupDays);
                updateThreshold(connection, appId, normalizedRegion, QUANTITY_TOLERANCE_PERCENT, quantityTolerancePercent, 0);
                updateThreshold(connection, appId, normalizedRegion, TOTAL_AMOUNT_TOLERANCE_PERCENT, totalAmountTolerancePercent, 0);
                connection.commit();
            ...
            throw new IllegalStateException("Failed to update calibration thresholds for appid="
    ...
    private void updateThreshold(
        ...
        throw new IllegalStateException("No calibration threshold row found for appid="
                + appId + ", region=" + region + ", thresholdName=" + thresholdName);
    }
