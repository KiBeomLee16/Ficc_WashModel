...
public class CalibrationRunRequestController {
    ...
    public CalibrationRunRequestController(
            CalibrationThresholdRepository calibrationThresholdRepository,
            RunRequestRepository runRequestRepository
    ) {
        this.calibrationThresholdRepository = Objects.requireNonNull(
    ...
    @PostMapping(
            value = "/calibration-run-request",
            consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE
    )
    @ResponseBody
    public ResponseEntity<CalibrationRunRequestResponse> submitCalibrationRunRequest(
            @RequestParam int appId,
            @RequestParam String region,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate businessDate,
            @RequestParam BigDecimal oneTimeMinTotalAmount,
            @RequestParam BigDecimal cumulativeMinTotalAmount,
            @RequestParam BigDecimal quantityTolerancePercent,
            @RequestParam BigDecimal totalAmountTolerancePercent,
        ...
        calibrationThresholdRepository.updateCalibrationThresholds(
                appId,
                normalizedRegion,
        ...
        return ResponseEntity.accepted().body(new CalibrationRunRequestResponse(
                requestId,
                appId,
                normalizedRegion,
                businessDate,
    ...
    public record CalibrationRunRequestResponse(
            long requestId,
            int appId,
            String region,
