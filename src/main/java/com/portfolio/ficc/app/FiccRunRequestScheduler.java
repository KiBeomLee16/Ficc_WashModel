...
@Service
@ConditionalOnProperty(prefix = "surveillance.worker", name = "enabled", havingValue = "true", matchIfMissing = true)
public class FiccRunRequestScheduler {
	...
	@Scheduled(initialDelayString = "${surveillance.worker.initial-delay-ms:3000}", fixedDelayString = "${surveillance.worker.fixed-delay-ms:5000}")
